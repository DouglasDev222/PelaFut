-- Adiciona os campos de tempo das rodadas ao RPC público, para a página
-- pública mostrar a duração de cada jogo e a média — como no app privado.
-- Mesma função da 0019, só com started_at/finished_at/paused_at/paused_seconds
-- na CTE `rodadas` e no JSON de `rounds`.
